...
#undef STR
    ...
    const std::string ToString(VkExtent2D extent)
    {
    ...
    /* const std::string ToString(sg::AlphaMode mode)
    {
    ...
    const std::string ToString(ShaderResourceType type)
    {
        switch (type)
        {
    ...
    const std::string buffer_usage_ToString(VkBufferUsageFlags flags)
    {
    ...
    const std::string shader_stage_ToString(VkShaderStageFlags flags)
    {
    ...
    const std::string image_usage_ToString(VkImageUsageFlags flags)
    {
    ...
    const std::string image_aspect_ToString(VkImageAspectFlags flags)
    {
    ...
    const std::string cull_mode_ToString(VkCullModeFlags flags)
    {
    ...
    const std::string color_component_ToString(VkColorComponentFlags flags)
    {
