...
#
# glslang_FOUND          - True if glslang was found glslang_INCLUDE_DIRS   -
# include directories for glslang glslang_LIBRARIES      - link against this
# library to use glslang
#
# The module will also define two cache variables::
#
# glslang_INCLUDE_DIR    - the glslang include directory glslang_LIBRARY - the
...
if(DEFINED ENV{VULKAN_SDK})
  if(WIN32)
    ...
    if(CMAKE_SIZEOF_VOID_P EQUAL 8)
      set(ADDITIONAL_PATHS_LIBS "$ENV{VULKAN_SDK}/Lib" "$ENV{VULKAN_SDK}/Bin")
    elseif(CMAKE_SIZEOF_VOID_P EQUAL 4)
      set(ADDITIONAL_PATHS_LIBS "$ENV{VULKAN_SDK}/Lib32"
...
if(WIN32)
  ...
  find_library(
    MachineIndependent_LIBRARY_debug
    NAMES MachineIndependentd
    PATHS ${ADDITIONAL_PATHS_LIBS})

  find_library(
    GenericCodeGen_LIBRARY_debug
    NAMES GenericCodeGend
    PATHS ${ADDITIONAL_PATHS_LIBS})

  find_library(
    SPIRV-Tools_LIBRARY_debug
    NAMES SPIRV-Toolsd
    PATHS ${ADDITIONAL_PATHS_LIBS})

  find_library(
    SPIRV-Tools-opt_LIBRARY_debug
...
if(glslang_FOUND AND NOT TARGET glslang::glslang)
  ...
  set_target_properties(
    glslang::glslang
    PROPERTIES IMPORTED_LOCATION "${glslang_LIBRARY}"
               INTERFACE_INCLUDE_DIRECTORIES "${glslang_INCLUDE_DIRS}")

  add_library(glslang::OSDependent UNKNOWN IMPORTED)
  set_target_properties(
    glslang::OSDependent
    PROPERTIES IMPORTED_LOCATION "${OSDependent_LIBRARY}"
               INTERFACE_INCLUDE_DIRECTORIES "${OSDependent_INCLUDE_DIRS}")

  add_library(glslang::SPIRV UNKNOWN IMPORTED)
  set_target_properties(
    glslang::SPIRV
    PROPERTIES IMPORTED_LOCATION "${SPIRV_LIBRARY}"
               INTERFACE_INCLUDE_DIRECTORIES "${spirv_INCLUDE_DIR}")

  add_library(glslang::OGLCompiler UNKNOWN IMPORTED)
  set_target_properties(
    glslang::OGLCompiler
    PROPERTIES IMPORTED_LOCATION "${OGLCompiler_LIBRARY}"
               INTERFACE_INCLUDE_DIRECTORIES "${glslang_INCLUDE_DIRS}")

  add_library(glslang::HLSL UNKNOWN IMPORTED)
  set_target_properties(
    glslang::HLSL
    PROPERTIES IMPORTED_LOCATION "${HLSL_LIBRARY}" INTERFACE_INCLUDE_DIRECTORIES
  ...
  if(SPIRV-Tools_LIBRARY)
    ...
    set_target_properties(
      glslang::SPIRV-Tools
      PROPERTIES IMPORTED_LOCATION "${SPIRV-Tools_LIBRARY}"
                 INTERFACE_INCLUDE_DIRECTORIES "${SPIRV-Tools__INCLUDE_DIR}")
  endif()
  ...
  if(SPIRV-Tools-opt_LIBRARY)
    ...
    set_target_properties(
      ...
      PROPERTIES IMPORTED_LOCATION "${SPIRV-Tools-opt_LIBRARY}"
                 INTERFACE_INCLUDE_DIRECTORIES "${SPIRV-Tools-opt_INCLUDE_DIR}")
  endif()
  ...
  if(MachineIndependent_LIBRARY)
    ...
    set_target_properties(
      ...
      PROPERTIES IMPORTED_LOCATION "${MachineIndependent_LIBRARY}"
                 INTERFACE_INCLUDE_DIRECTORIES
                 "${MachineIndependent_INCLUDE_DIRS}")
  endif()
  ...
  if(GenericCodeGen_LIBRARY)
    ...
    set_target_properties(
      ...
      PROPERTIES IMPORTED_LOCATION "${GenericCodeGen_LIBRARY}"
                 INTERFACE_INCLUDE_DIRECTORIES "${GenericCodeGen_INCLUDE_DIRS}")
  endif()

  if(WIN32)
    set_target_properties(
      glslang::glslang PROPERTIES IMPORTED_LOCATION_DEBUG
                                  "${glslang_LIBRARY_debug}")
    set_target_properties(
      glslang::OSDependent PROPERTIES IMPORTED_LOCATION_DEBUG
                                      "${OSDependent_LIBRARY_debug}")
    set_target_properties(glslang::SPIRV PROPERTIES IMPORTED_LOCATION_DEBUG
                                                    "${SPIRV_LIBRARY_debug}")
    set_target_properties(
      glslang::OGLCompiler PROPERTIES IMPORTED_LOCATION_DEBUG
                                      "${OGLCompiler_LIBRARY_debug}")
    set_target_properties(glslang::HLSL PROPERTIES IMPORTED_LOCATION_DEBUG
                                                   "${HLSL_LIBRARY_debug}")
    ...
    if(GenericCodeGen_LIBRARY_debug)
      set_target_properties(
        glslang::GenericCodeGen PROPERTIES IMPORTED_LOCATION_DEBUG
                                           "${GenericCodeGen_LIBRARY_debug}")
    endif()
    if(SPIRV-Tools_LIBRARY_debug)
      set_target_properties(
        glslang::SPIRV-Tools PROPERTIES IMPORTED_LOCATION_DEBUG
                                        "${SPIRV-Tools_LIBRARY_debug}")
    endif()
    if(SPIRV-Tools-opt_LIBRARY_debug)
      set_target_properties(
        glslang::SPIRV-Tools-opt PROPERTIES IMPORTED_LOCATION_DEBUG
                                            "${SPIRV-Tools-opt_LIBRARY_debug}")
    endif()
  endif()
  ...
  if(MachineIndependent_LIBRARY AND GenericCodeGen_LIBRARY)
    ...
    set(glslang_LIBRARIES
        glslang::MachineIndependent glslang::OSDependent glslang::OGLCompiler
        glslang::SPIRV glslang::GenericCodeGen)
  else()
    # VULKAN_SDK and associated glslang before 1.2.147.1
    set(glslang_LIBRARIES glslang::glslang glslang::OSDependent
                          glslang::OGLCompiler glslang::SPIRV glslang::HLSL)
  endif()
