...
#
# SPDLOG_FOUND - system has Spdlog SPDLOG_INCLUDE_DIRS - the Spdlog include
# directory SPDLOG_LIBRARIES - the Spdlog libraries SPDLOG_DEFINITIONS - the
...
if(ENABLE_INTERNAL_SPDLOG)
  ...
  # allow user to override the download URL with a local tarball needed for
  # offline build envs
  if(SPDLOG_URL)
    get_filename_component(SPDLOG_URL "${SPDLOG_URL}" ABSOLUTE)
  else()
    set(SPDLOG_URL
        http://mirrors.kodi.tv/build-deps/sources/spdlog-${SPDLOG_VERSION}.tar.gz
    )
  endif()
  if(VERBOSE)
  ...
  ExternalProject_Add(
    ...
    PATCH_COMMAND
      patch -p1 -i
      ${CMAKE_SOURCE_DIR}/tools/depends/target/libspdlog/0001-fix_fmt_version.patch
